...
**対応ADR**: docs/adr/adr-0.11.3.md, docs/adr/adr-0.11.4.md, docs/adr/adr-0.11.5.md
...
> 注: 具体的コマンドやコード例は tree には置かない（ADR 0.11.4/0.11.5 を参照）。

---

## 構成原則（ADR 0.11.3/0.11.4/0.11.5準拠）
