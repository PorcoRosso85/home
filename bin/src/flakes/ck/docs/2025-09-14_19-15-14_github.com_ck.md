...
1. **Code:** Submit PRs for bug fixes, new features
1. **Documentation:** Improve examples, guides, tutorials
1. **Testing:** Help test on different codebases and languages
