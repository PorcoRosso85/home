...
``` 1. **Find a company and get their latest financial data**:
...
[Buy Me A Coffee](https://www.buymeacoffee.com/edgartools)
...
**[Quick Start Tutorial](quick-guide/)**
...
**Ready to start analyzing SEC data?** [Install EdgarTools](installation/) and begin your first analysis today.
