...
def create_database(path: Optional[str], in_memory: bool) -> DBResult:
    ...
    try:
        ...
        return DBError(ok=False, error=f"KuzuDB import failed: {e}\nLD_LIBRARY_PATH: {ld_path}\nTry: nix develop")
    ...
    try:
        ...
        return DBError(ok=False, error=f"Failed to create database: {e}")
...
def create_connection(database: Any) -> ConnResult:
    ...
    try:
        ...
        return ConnError(ok=False, error=f"Failed to create connection: {e}")
