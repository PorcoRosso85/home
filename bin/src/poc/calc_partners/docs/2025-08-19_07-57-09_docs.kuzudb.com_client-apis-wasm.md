...
[WebAssembly](https://webassembly.org/), a.k.a. *Wasm*, is a standard defining any suitable low-level
...
```
import kuzu from "kuzu-wasm";kuzu.setWorkerPath('path/to/worker.js');
```
