...
declare module 'hono' {
  interface ContextRenderer {
    (component: React.ReactNode): Response | Promise<Response>
  }
}

export const rscRenderer = createMiddleware(async (c, next) => {
  ...
  c.setRenderer(async (component: React.ReactNode) => {
    ...
    // Create RSC payload with the component
