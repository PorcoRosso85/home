...
function App() {
  return `
    <div style="max-width: 800px; margin: 0 auto; padding: 20px;">
      <h1>\u{1F680} React Transition Demo (Worker \xD7 SSR)</h1>
      ...
      <div style="padding: 16px; background: #f8f9fa; border-radius: 8px; font-size: 14px; color: #666;">
        <strong>\u{1F3D7}\uFE0F Technical Implementation:</strong>
...
var worker_default = {
  async fetch(request, env2) {
    ...
    if (url.pathname.startsWith("/assets/")) {
      ...
      return env2.ASSETS.fetch(new Request(`https://example.com/${assetPath}`, request));
    }
    const appHtml = App();
    const html = `
      <!DOCTYPE html>
...
// .wrangler/tmp/bundle-M4wC6j/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-M4wC6j/middleware-loader.entry.ts
