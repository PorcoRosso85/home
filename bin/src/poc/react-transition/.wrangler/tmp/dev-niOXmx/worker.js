...
var worker_default = {
  async fetch(request, env2) {
    ...
    if (url.pathname.startsWith("/assets/")) {
      ...
      return env2.ASSETS.fetch(new Request(`/${assetPath}`, request));
    }
    const appHtml = App();
    const html = `
      <!DOCTYPE html>
...
// .wrangler/tmp/bundle-ucCGfi/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-ucCGfi/middleware-loader.entry.ts
