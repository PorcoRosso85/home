...
class TestFTSSearchLogic:
    ...
    def test_single_keyword_search_returns_matching_documents(self):
        ...
        # 検索実行（実装前なので失敗する）
        from fts_kuzu.domain import search_documents_by_keyword
    ...
    def test_multiple_keywords_or_search_returns_any_match(self):
        ...
        # OR検索実行（実装前なので失敗する）
        from fts_kuzu.domain import search_documents_with_or_logic
    ...
    def test_bm25_scoring_ranks_documents_by_relevance(self):
        ...
        # BM25検索実行（実装前なので失敗する）
        from fts_kuzu.domain import search_with_bm25_scoring
    ...
    def test_search_results_include_position_highlights(self):
        ...
        from fts_kuzu.domain import search_with_highlights
...
class TestAdvancedFTSFeatures:
    ...
    def test_phrase_search_finds_exact_phrases(self):
        ...
        # フレーズ検索実行（実装前なので失敗する）
        from fts_kuzu.domain import search_phrase
    ...
    def test_conjunctive_search_returns_all_keywords_match(self):
        ...
        # AND検索実行（実装前なので失敗する）
        from fts_kuzu.domain import validate_conjunctive_results
    ...
    def test_title_boost_prioritizes_title_matches(self):
        ...
        from fts_kuzu.domain import boost_title_matches
    ...
    def test_section_filter_searches_within_specific_sections(self):
        ...
        # セクション内検索（実装前なので失敗する）
        from fts_kuzu.domain import filter_by_section
