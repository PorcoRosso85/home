 ...
 * 再帰に関する特性
 */
export interface RecursionFeature {
  isRecursive?: boolean;
  recursionLimit?: number | null;
  tailRecursive?: boolean;
  recursionType?: 'direct' | 'mutual' | 'nested';
  ...
  mutuallyRecursiveWith?: Array<{
    name: string;
    $ref?: string;
  }>;
  invariants?: string[];
  transformationType?: Array<'tailCall' | 'accumulator' | 'trampolined' | 'none'>;
  structuralRecursion?: boolean;
}
