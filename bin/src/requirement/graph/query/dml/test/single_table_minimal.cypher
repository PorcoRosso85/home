...
CREATE REL TABLE CONTAINS_LOCATION(FROM LocationURI TO LocationURI, relation_type STRING);
...
MERGE (p)-[:CONTAINS_LOCATION {relation_type: 'file_hierarchy'}]->(c);
...
MERGE (p1)-[:CONTAINS_LOCATION {relation_type: 'file_hierarchy'}]->(p2)
WITH parts
MATCH (p2:LocationURI {id: "/" + parts[1] + "/" + parts[2]}), (p3:LocationURI {id: "/" + parts[1] + "/" + parts[2] + "/" + parts[3]})
MERGE (p2)-[:CONTAINS_LOCATION {relation_type: 'file_hierarchy'}]->(p3);
...
WITH parts
MATCH (p1:LocationURI {id: "/" + parts[1]}), (p2:LocationURI {id: "/" + parts[1] + "/" + parts[2]})
MERGE (p1)-[:CONTAINS_LOCATION {relation_type: 'requirement_hierarchy'}]->(p2)
WITH parts
MATCH (p2:LocationURI {id: "/" + parts[1] + "/" + parts[2]}), (p3:LocationURI {id: "/" + parts[1] + "/" + parts[2] + "/" + parts[3]})
MERGE (p2)-[:CONTAINS_LOCATION {relation_type: 'requirement_hierarchy'}]->(p3)
WITH parts
MATCH (p3:LocationURI {id: "/" + parts[1] + "/" + parts[2] + "/" + parts[3]}), (p4:LocationURI {id: "/" + parts[1] + "/" + parts[2] + "/" + parts[3] + "/" + parts[4]})
MERGE (p3)-[:CONTAINS_LOCATION {relation_type: 'requirement_hierarchy'}]->(p4);
...
WITH parts
MATCH (p3:LocationURI {id: "/" + parts[1] + "/" + parts[2] + "/" + parts[3]}), (p4:LocationURI {id: "/" + parts[1] + "/" + parts[2] + "/" + parts[3] + "/" + parts[4]})
MERGE (p3)-[:CONTAINS_LOCATION {relation_type: 'file_hierarchy'}]->(p4)
WITH parts
MATCH (p4:LocationURI {id: "/" + parts[1] + "/" + parts[2] + "/" + parts[3] + "/" + parts[4]}), (p5:LocationURI {id: "/" + parts[1] + "/" + parts[2] + "/" + parts[3] + "/" + parts[4] + "/" + parts[5]})
MERGE (p4)-[:CONTAINS_LOCATION {relation_type: 'file_hierarchy'}]->(p5)
WITH parts
...
MERGE (p5)-[:CONTAINS_LOCATION {relation_type: 'file_hierarchy'}]->(p6)
WITH parts
...
MERGE (p6)-[:CONTAINS_LOCATION {relation_type: 'file_hierarchy'}]->(p7)
WITH parts
...
MERGE (p7)-[:CONTAINS_LOCATION {relation_type: 'file_hierarchy'}]->(p8);