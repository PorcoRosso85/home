...
class TestClaudeBusinessRules:
    ...
    def test_generate_claude_window_name_simple_path(self):
        ...
        assert result == "developer:_home_user_project"
    ...
    def test_generate_claude_window_name_complex_path(self):
        ...
        assert result == "developer:_home_user_my-project_src"
...
class TestGenericWorkerRules:
    ...
    def test_extract_directory_from_window_name_claude(self):
        ...
        result = domain.extract_directory_from_window_name("developer:_home_user_project")
    ...
    def test_is_worker_window_claude(self):
        ...
        assert domain.is_worker_window("developer:_home_user") is True
    ...
    def test_is_worker_window_custom_prefix(self):
        ...
        assert domain.is_worker_window("developer:_test", tool_prefix="gemini:") is False
