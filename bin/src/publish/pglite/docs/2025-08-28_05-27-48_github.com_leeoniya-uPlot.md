...
## [uPlot logo](/leeoniya/uPlot/blob/master/uPlot.svg) μPlot

[](#-μplot)

A small ( [~50 KB min](https://github.com/leeoniya/uPlot/tree/master/dist/uPlot.iife.min.js)), [fast](#performance) chart for time series, lines, areas, ohlc & bars *(MIT Licensed)*
...
[uPlot Chart](/leeoniya/uPlot/blob/master/uPlot.png)
...
- No data parsing, aggregation, summation or statistical processing - just do it in advance. e.g. [simples-statistics](https://simple-statistics.github.io/), [https://github.com/leeoniya/uDSV](https://github.com/leeoniya/uDSV)
...
[uPlot Performance](/leeoniya/uPlot/blob/master/perf.png)

Full size: [https://leeoniya.github.io/uPlot/demos/multi-bars.html](https://leeoniya.github.io/uPlot/demos/multi-bars.html)

Raw data: [https://github.com/leeoniya/uPlot/blob/master/bench/results.json](https://github.com/leeoniya/uPlot/blob/master/bench/results.json)
...
- [https://echarts.apache.org/next/examples/en/index.html](https://echarts.apache.org/next/examples/en/index.html)
- [https://github.com/sveinn-steinarsson/flot-downsample/](https://github.com/sveinn-steinarsson/flot-downsample/)
- [https://dygraphs.com/tests/dygraph-many-points-benchmark.html](https://dygraphs.com/tests/dygraph-many-points-benchmark.html)
- [https://www.chartjs.org/docs/latest/general/performance.html](https://www.chartjs.org/docs/latest/general/performance.html)
- [https://dash.plotly.com/performance](https://dash.plotly.com/performance)
- [https://www.highcharts.com/docs/advanced-chart-features/boost-module](https://www.highcharts.com/docs/advanced-chart-features/boost-module)
- [https://danchitnis.github.io/webgl-plot-examples/vanilla/](https://danchitnis.github.io/webgl-plot-examples/vanilla/)
- [https://huww98.github.io/TimeChart/docs/performance](https://huww98.github.io/TimeChart/docs/performance)
- [https://www.arction.com/lightningchart-js-performance/](https://www.arction.com/lightningchart-js-performance/)
...
Head over to [https://leeoniya.github.io/uPlot/demos/sine-stream.html](https://leeoniya.github.io/uPlot/demos/sine-stream.html) and open up Chrome's DevTools (F12), then toggle the Performance Monitor.

[Chrome DevTools Peformance Monitor](/leeoniya/uPlot/blob/master/img/chrome-perf-monitor.png)
...
[Chrome gpu](/leeoniya/uPlot/blob/master/img/chrome-gpu.png)

Then open `chrome://flags` and search for "raster" to see what can be force-enabled.

[Chrome flags](/leeoniya/uPlot/blob/master/img/chrome-flags.png)
