...
1. Locate and select your bucket from the list.
1. From your bucket’s page, select **Settings**.
1. Under **CORS Policy**, select **Add CORS policy**.
1. From the **JSON** tab, manually enter or copy and paste your policy into the text box.
