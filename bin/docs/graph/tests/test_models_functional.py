"""Test functional models - ensure same behavior as Pydantic models."""

from pathlib import Path

import pytest

from flake_graph.models_functional import (
    create_dependency,
    create_flake_info,
    get_flake_responsibility,
    get_flake_id
)


def test_flake_dependency_creation():
    """Test FlakeDependency creation."""
...
def test_flake_info_get_responsibility():
    ...
    assert get_flake_responsibility(info) == "Test flake for unit testing"
...
def test_flake_info_get_id():
    ...
    assert get_flake_id(info) == "persistence/kuzu_py"
...
def test_flake_info_get_id_outside_src():
    ...
    assert get_flake_id(info) == "/home/nixos/other/test"